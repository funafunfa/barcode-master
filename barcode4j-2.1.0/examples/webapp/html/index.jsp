    ...
    <form method="post" action="index.jsp">
      <table border="0">
        ...
        <tr>
          ...
          <td>
            <p>Applies to bitmap formats only. usseless.Example: 300</p>
          </td>
        </tr>
        <tr>
          <td>
        ...
        <tr>
          ...
          <td>
            <p>usseless.Example: 10mw or 1cm. Use "disable" to disable the quiet zone.</p>
          </td>
        </tr>
        <tr>
          <td>
        ...
        <tr>
          ...
          <td>
            <p>usseless.Example: "Helvetica"</p>
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            <p>usseless.Example: "\_patterned\_:__/__/____" (Any '_' is placeholder for the next message symbol, all other pattern symbols will be inserted between. The '\' is escape char. If the patterned message is too long you can increase the quite zone lenght to make it visible)</p>
          </td>
        </tr>
        <tr>
          <td/>
